...
> 状态：**设计稿（实施中，2026-06-10 复工）** · 2026-06-07 · 对应博客设计篇 [D1](../../blog/zh/d1-advanced-rag.md)
> 🔒 **实施决策以《[RAG 最终实施方案](./2026-06-10-rag-final-implementation-spec.md)》为准**（与本文偏差：嵌入=智谱 embedding-3 @ 1024 维而非 1536、`project_id` 惯例而非 scope 枚举、独立 `rag` 队列、kb_search 经 app 回调）。本文保留完整设计理据。
